...
import ABI from '../../artifacts/paras_launchpad.json';
import QueryMethods from '../query/paras_launchpad';
import BuildExtrinsicMethods from '../build-extrinsic/paras_launchpad';
import TxSignAndSendMethods from '../tx-sign-and-send/paras_launchpad';
import MixedMethods from '../mixed-methods/paras_launchpad';
import EventsClass from '../events/paras_launchpad';
